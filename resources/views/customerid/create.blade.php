...
<div class="container">
    ...
    <form action="{{ route('customer-creation.store') }}" method="POST">
        ...
        <!-- User Code -->
        <div class="mb-3">
            <label for="costomer_code" class="form-label">Costomer Code</label>
            <input type="text" class="form-control" name="costomer_code" id="costomer_code" value="Auto-generated" disabled>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="state_id" id="district_id" class="form-control"></select>
        </div>
        <div class="mb-3">
